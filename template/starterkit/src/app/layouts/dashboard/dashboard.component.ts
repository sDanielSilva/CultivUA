...
import { TablerIconsModule } from "angular-tabler-icons"; //import { AppHorizontalSidebarComponent } from './horizontal/sidebar/sidebar.component';
...
@Component({
    ...
    imports: [
        ...
        SidebarComponent,
        NgScrollbarModule,
        TablerIconsModule, //AppHorizontalSidebarComponent,
...
export class DashboardComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.adminImg = sessionStorage.getItem('admin_image');
    }
